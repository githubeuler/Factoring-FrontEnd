                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        if (data.nEstado == '0') {
                            ...
                            if (data.nEstado != '10' && data.nEstado != '0') {
                                buttonAction += `<a href="javascript:;" class="btn btn-icon btn-light-dark btn-sm open-modal oculto-acci p-cal" data-bs-toggle="modal" data-bs-target="#kt_modal_calcular_operacion" data-n-operacion=${data.nIdOperaciones} data-n-nroperacion=${data.nNroOperacion} title="Calcular"><i class="las la-calculator fs-2"></i></a>`;
                            }
